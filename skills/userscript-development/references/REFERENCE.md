...
Implementation patterns for the workflow in [SKILL.md](../SKILL.md). Workflow steps and completion criteria live there; runtime, DOM, storage, orchestration, and test patterns live here.
